namespace Products.API.Controllers
{
    ...
    public class CustomersController : ApiController
    {
        ...
        /// <summary>
        /// Metodo que crea el Usuario ASP (Security EntityFramework)
        /// </summary>
        /// <param name="email">String que almacena el email del usuario</param>
        /// <param name="password">String que almacena el password del usuario</param>
        /// <returns></returns>
        private bool CreateUserASP(string email, string password)
        {
            //  Objetos para crear el usuario ASP
            var userContext = new ApplicationDbContext();
